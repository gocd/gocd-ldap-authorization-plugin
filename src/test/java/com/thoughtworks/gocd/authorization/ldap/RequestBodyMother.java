...
public class RequestBodyMother {
    ...
    public static String forSearchUser(String username, String searchBase) {
        Map<String, Object> requestMap = getRequestBodyMap(username, "ldap", searchBase);
        return gson.toJson(requestMap);
    }

    public static String searchUserWithAuthConfig(String username, String searchBase) {
        Map<String, Object> requestMap = new HashMap<>();
        requestMap.put("username", username);
        requestMap.put("auth_config", AuthConfig.fromJSON(authConfigJson("ldap", searchBase, "")));
    ...
    private static Map<String, Object> getRequestBodyMap(String username, String authConfigId, String searchBase) {
        Map<String, Object> requestMap = new HashMap<>();
        requestMap.put("username", username);
        requestMap.put("auth_configs", Collections.singletonList(AuthConfig.fromJSON(authConfigJson(authConfigId, searchBase, ""))));
        requestMap.put("role_configs", Collections.emptyList());
    ...
    public static String getRequestBodyMapForIsUserValid(String username, String authConfigId, String searchBase) {
        Map<String, Object> requestMap = new HashMap<>();
        requestMap.put("username", username);
        requestMap.put("auth_config", AuthConfig.fromJSON(authConfigJson(authConfigId, searchBase, "")));
        return gson.toJson(requestMap);
    }

    public static String forAuthorizeWithAttribute(String username, String searchBase, String roleName, String authConfigId, String attributeName, String attributeValue) {
        Map<String, Object> requestMap = getRequestBodyMap(username, authConfigId, searchBase);
        requestMap.put("role_configs", Collections.singletonList(RoleConfig.fromJSON(roleConfigJson(roleName, authConfigId, attributeName, attributeValue, null, ""))));
        return gson.toJson(requestMap);
    }
