...
public class CertificateValidatorTest {
    ...
    public void shouldReturnErrorIfCertificateIsExpired() throws Exception {
        ...
        final ValidationError validationError = result.allErrors().get(0);
        assertThat(validationError.key(), is("Certificate"));
        assertThat(validationError.message(), startsWith("Invalid Certificate, expired on `8/30/17"));
    }

    private String EXPIRED_CERT = "-----BEGIN CERTIFICATE-----\n" +
    ...
    private String VALID_CERT_TEXT = "-----BEGIN CERTIFICATE-----\n" +
