...
import com.thoughtworks.gocd.authorization.ldap.model.Capabilities;
import com.thoughtworks.gocd.authorization.ldap.model.SupportedAuthType;
...
public class GetCapabilitiesExecutor {
    ...
    Capabilities getCapabilities() {
        return new Capabilities(SupportedAuthType.Password, true, true, true);
    }
}
